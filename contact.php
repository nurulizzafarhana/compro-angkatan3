                   ...
                   <?php
                    if (isset($_GET['status'])) {
                        if ($_GET['status'] == "success") {
                            ?>
                            <div class='alert alert-success' role='alert'>Data berhasil ditambah dan tunggu balasannya!</div>
                            <?php
                        } elseif ($_GET['status'] == "email-sudahada") {
                            ?>
                            <div class='alert alert-danger' role='alert'>Email sudah digunakan, gunakan email lain!</div>
                            <?php
                        }
                    }
                    ?>
